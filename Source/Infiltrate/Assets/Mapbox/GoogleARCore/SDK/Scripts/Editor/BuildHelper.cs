...
namespace GoogleARCoreInternal
{
    ...
    public class BuildHelper : IPreprocessBuild
    {
        ...
        public void OnPreprocessBuild(BuildTarget target, string path)
        {
            ...
            const string k_RequiredAARPath = "Assets/Mapbox/GoogleARCore/SDK/Plugins/google_ar_required.aar";
            const string k_OptionalAARPath = "Assets/Mapbox/GoogleARCore/SDK/Plugins/google_ar_optional.aar";
